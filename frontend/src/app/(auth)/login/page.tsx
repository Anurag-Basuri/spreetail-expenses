  ...
  return (
    <Card padding="lg">
      ...
      <div className="space-y-4 mb-6">
        <Button type="button" variant="secondary" className="w-full relative justify-center">
          <svg className="w-5 h-5 absolute left-4" viewBox="0 0 24 24">
            ...
            <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.16C1.43 8.55 1 10.22 1 12s.43 3.45 1.16 4.93l2.84-2.22.84-.62z" />
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-surface text-ink-400">Or continue with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-between mt-2 mb-6">
          <div className="flex items-center">
            <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 text-brand-600 focus:ring-brand-500 border-border rounded" />
        ...
        <Button type="submit" className="w-full shadow-md" size="lg" loading={loading}>
          Sign in to account
        </Button>
      </form>
