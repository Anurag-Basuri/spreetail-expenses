    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {splitType !== "equal" && selectedUserIds.size > 0 && (
            <div className="p-4 bg-canvas rounded-xl border border-border space-y-3">
              <h4 className="text-xs font-bold text-ink-400 uppercase tracking-wider mb-2">Enter {splitType}</h4>
                ...
                <div key={m.user_id} className="flex items-center justify-between gap-4">
                  ...
                  <div className="relative w-32">
                    ...
                    <input 
                      ...
                      onChange={(e) => setSplitDetails(prev => ({...prev, [m.user_id]: parseFloat(e.target.value) || 0}))}
                    />
